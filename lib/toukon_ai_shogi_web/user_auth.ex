defmodule ToukonAiShogiWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ToukonAiShogiWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp assign_scope(socket, session) do
    case socket.assigns do
      ...
      _ ->
        ...
        %{socket | assigns: Map.put(socket.assigns, :current_scope, scope)}
    end
  end
