defmodule ToukonAiShogiWeb.UserAuthTest do
  use ToukonAiShogiWeb.ConnCase, async: true

  alias ToukonAiShogi.Accounts
  alias ToukonAiShogi.Accounts.Scope
  alias ToukonAiShogiWeb.UserAuth

  import ToukonAiShogi.AccountsFixtures

  @remember_me_cookie "_toukon_ai_shogi_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ToukonAiShogiWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
